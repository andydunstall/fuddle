...
func (c *registryClient) Register(ctx context.Context, opts ...grpc.CallOption) (Registry_RegisterClient, error) {
	stream, err := c.cc.NewStream(ctx, &Registry_ServiceDesc.Streams[0], "/Registry/Register", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *registryRegisterClient) Send(m *NodeUpdate) error {
	return x.ClientStream.SendMsg(m)
}

func (x *registryRegisterClient) Recv() (*NodeUpdate, error) {
	m := new(NodeUpdate)
...
func (x *registryRegisterServer) Send(m *NodeUpdate) error {
	return x.ServerStream.SendMsg(m)
}

func (x *registryRegisterServer) Recv() (*NodeUpdate, error) {
	m := new(NodeUpdate)
